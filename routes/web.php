...
Route::get('/backend/courses/create', [CourseController::class, 'create'])->name('courses.create');
Route::post('/backend/courses', [CourseController::class, 'store'])->name('courses.store');
